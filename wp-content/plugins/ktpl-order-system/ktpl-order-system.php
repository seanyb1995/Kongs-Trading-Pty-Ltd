...
*/
if(!function_exists('ktpl_customer_order_menu')){
    function ktpl_customer_order_menu(){
        /*
        ...
        */
        add_menu_page(
            ...
            'ktpl_customer_order_options_page', //function
            'dashicons-list-view' //icon
            );
    }
    // add_action hook - this hooks our function into WordPress
    add_action( 'admin_menu', 'ktpl_customer_order_menu' ); 
}
...
if ( !function_exists('ktpl_customer_order_options_page') ) {
    function ktpl_customer_order_options_page(){
...
*/
if(!function_exists('ktpl_customer_order_dbsetup')){
    function ktpl_customer_order_dbsetup(){
    ...
    register_activation_hook(__FILE__, 'ktpl_customer_order_dbsetup');
}
...
*/ 
if( !function_exists('ktpl_customer_order_include_template_tags') ) {
    function ktpl_customer_order_include_template_tags() {
        global $customer_order_plugin_root;
        include_once( $customer_order_plugin_root . 'inc/template-tags.php' );
    }
    add_action( 'after_setup_theme', 'ktpl_customer_order_include_template_tags' );
}
